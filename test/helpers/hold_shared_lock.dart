/// Standalone helper script (NOT a test-framework file): acquires a SHARED
/// [StoreInstanceGuard] lock on the store directory given as `args[0]`,
/// signals readiness on stdout, then blocks until the parent process closes
/// stdin, at which point it releases the lock and exits cleanly.
///
/// Used by test/instance_guard_test.dart to spawn a genuine second OS
/// process holding a shared lock, exercising real cross-process advisory
/// file locking (not just in-process behavior).
///
